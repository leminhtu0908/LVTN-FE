...
const NewsTrick = () => {
  ...
  useEffect(() => {
    const filterData = data?.filter((item) => item.typeNew === "meo-hay");
          ...
          <>
            ...
            >
              ...
              <div className="basis-[85%] ">
                <div className="mt-3">
                  <span className="px-4 py-2 rounded-3xl bg-red-500 text-white text-sm">
                    {item.typeNew === "meo-hay" && "Mẹo hay"}
                  </span>
                </div>
